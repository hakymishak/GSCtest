...
a:hover, a:active {
  background-color: rgb(0, 0, 0);
		...
		<div class="h1">
			...
			<a href="pages/home.php" target="_blank">H O M E</a>
			<a href="pages/abus.php"_blank">ABOUT US</a>
			<a href="pages/games.php" target="_blank">GAMES</a>
			<a href="pages/cous.php" target="_blank">CONTACT US</a>
